...
This is an industry-grade, professional option pricing and risk management platform that implements sophisticated quantitative finance models. The platform provides comprehensive tools for pricing various types of options, conducting risk analysis, and performing advanced analytics.
...
├── advanced_models.py        # Monte Carlo, Heston
